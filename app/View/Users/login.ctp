...
<?php echo $this->Html->link(__('Or create an account', true), array('controller' => 'users', 'action' => 'signup'), array('class' => 'btn btn-block btn-link'));
echo $this->Html->link(__('Or forgot your password?', true), array('controller' => 'users', 'action' => 'forgot_password'), array('class' => 'btn btn-block btn-link'));?>
